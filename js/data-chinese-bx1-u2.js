...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx1-u2-l1',
      cover: 'assets/cover/chinese/bx1-u2-l1.svg?v=20260809i',
    ...
    {
      id: 'bx1-u2-l2',
      cover: 'assets/cover/chinese/bx1-u2-l2.svg?v=20260809i',
      name: '心有一团火，温暖众人心',
      author: '林为民',
      chapter: '第二单元 劳动光荣（实用性阅读与交流）',
      difficulty: '简单',
    ...
    {
      id: 'bx1-u2-l3',
      cover: 'assets/cover/chinese/bx1-u2-l3.svg?v=20260809i',
      name: '探界者钟扬',
      author: '叶雨婷',
      chapter: '第二单元 劳动光荣（实用性阅读与交流）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u2-l4',
      cover: 'assets/cover/chinese/bx1-u2-l4.svg?v=20260809i',
      name: '芣苢',
      author: '《诗经·周南》',
      chapter: '第二单元 劳动光荣（实用性阅读与交流）',
      difficulty: '简单',
    ...
    {
      id: 'bx1-u2-l5',
      cover: 'assets/cover/chinese/bx1-u2-l5.svg?v=20260809i',
      name: '插秧歌',
      author: '杨万里',
      chapter: '第二单元 劳动光荣（实用性阅读与交流）',
      difficulty: '中等',
