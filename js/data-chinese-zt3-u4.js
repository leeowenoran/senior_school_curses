(function () {
  ...
  v.points.push(
    ...
    { id: 'zt3-u4-l1', name: '语言文字运用（七）：句式变换与选用', author: '高考复习', chapter: '考点七 · 句式变换与选用', difficulty: '中等',
      content: [
    ...
    { id: 'zt3-u4-l2', name: '语言文字运用（八）：压缩语段与扩展语句', author: '高考复习', chapter: '考点八 · 压缩语段与扩展语句', difficulty: '中等',
      content: [
    ...
    { id: 'zt3-u4-l3', name: '语言文字运用（九）：图文转换与表文转换', author: '高考复习', chapter: '考点九 · 图文转换与表文转换', difficulty: '中等',
      content: [
    ...
    { id: 'zt3-u4-l4', name: '语言文字运用（十）：备考总策略', author: '高考复习', chapter: '附录 · 语言文字运用备考总策略', difficulty: '中等',
      content: [
