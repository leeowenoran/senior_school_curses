...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx1-u6-l1',
      cover: 'assets/cover/chinese/bx1-u6-l1.svg',
      name: '劝学',
      author: '荀子',
    ...
    {
      id: 'bx1-u6-l2',
      cover: 'assets/cover/chinese/bx1-u6-l2.svg',
      name: '师说',
      author: '韩愈',
      chapter: '第六单元 学习之道（思辨性阅读与表达）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u6-l3',
      cover: 'assets/cover/chinese/bx1-u6-l3.svg',
      name: '反对党八股',
      author: '毛泽东',
      chapter: '第六单元 学习之道（思辨性阅读与表达）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u6-l4',
      cover: 'assets/cover/chinese/bx1-u6-l4.svg',
      name: '拿来主义',
      author: '鲁迅',
      chapter: '第六单元 学习之道（思辨性阅读与表达）',
      difficulty: '较难',
    ...
    {
      id: 'bx1-u6-l5',
      cover: 'assets/cover/chinese/bx1-u6-l5.svg',
      name: '读书：目的和前提',
      author: '黑塞',
      chapter: '第六单元 学习之道（思辨性阅读与表达）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u6-l6',
      cover: 'assets/cover/chinese/bx1-u6-l6.svg',
      name: '上图书馆',
      author: '王佐良',
      chapter: '第六单元 学习之道（思辨性阅读与表达）',
      difficulty: '简单',
