(function () {
  ...
  v.points.push(
    ...
    { id: 'zt4-u3-l1', name: '写作专题（五）：常见文体与题型专项', author: '高考复习', chapter: '第五部分 · 常见文体与题型专项', difficulty: '中等',
      content: [
    ...
    { id: 'zt4-u3-l2', name: '写作专题（六）：高考作文评分标准解读', author: '高考复习', chapter: '第六部分 · 高考作文评分标准解读', difficulty: '中等',
      content: [
