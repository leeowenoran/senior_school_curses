(function () {
  ...
  v.points.push(
    ...
    { id: 'zt3-u2-l1', name: '语言文字运用（三）：语言表达连贯', author: '高考复习', chapter: '考点三 · 语言表达连贯', difficulty: '中等',
      content: [
    ...
    { id: 'zt3-u2-l2', name: '语言文字运用（四）：语言表达得体', author: '高考复习', chapter: '考点四 · 语言表达得体', difficulty: '中等',
      content: [
