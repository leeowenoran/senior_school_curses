(function () {
  ...
  v.points.push(
    ...
    { id: 'zt3-u3-l1', name: '语言文字运用（五）：正确使用标点符号', author: '高考复习', chapter: '考点五 · 正确使用标点符号', difficulty: '中等',
      content: [
    ...
    { id: 'zt3-u3-l2', name: '语言文字运用（六）：正确使用常见的修辞手法', author: '高考复习', chapter: '考点六 · 正确使用修辞手法', difficulty: '中等',
      content: [
