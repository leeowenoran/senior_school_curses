...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'xb1-u1-l1',
      cover: 'assets/cover/chinese/xb1-u1-l1.svg',
      name: '《中国人民站起来了》',
      author: '毛泽东',
    ...
    {
      id: 'xb1-u1-l2',
      cover: 'assets/cover/chinese/xb1-u1-l2.svg',
      name: '《长征胜利万岁》',
      author: '杨成武',
      chapter: '第一单元 伟大的复兴（中国革命传统作品研习）',
      difficulty: '中等',
    ...
    {
      id: 'xb1-u1-l3',
      cover: 'assets/cover/chinese/xb1-u1-l3.svg',
      name: '《大战中的插曲》',
      author: '聂荣臻',
      chapter: '第一单元 伟大的复兴（中国革命传统作品研习）',
      difficulty: '中等',
    ...
    {
      id: 'xb1-u1-l4',
      cover: 'assets/cover/chinese/xb1-u1-l4.svg',
      name: '《别了，"不列颠尼亚"》',
      author: '周婷、杨兴',
      chapter: '第一单元 伟大的复兴（中国革命传统作品研习）',
      difficulty: '中等',
    ...
    {
      id: 'xb1-u1-l5',
      cover: 'assets/cover/chinese/xb1-u1-l5.svg',
      name: '《县委书记的榜样——焦裕禄》',
      author: '穆青、冯健、周原',
      chapter: '第一单元 伟大的复兴（中国革命传统作品研习）',
      difficulty: '中等',
    ...
    {
      id: 'xb1-u1-l6',
      cover: 'assets/cover/chinese/xb1-u1-l6.svg',
