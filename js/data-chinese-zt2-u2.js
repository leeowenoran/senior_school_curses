(function () {
  ...
  v.points.push(
    ...
    { id: 'zt2-u2-l1',    cover: 'assets/cover/chinese/zt2-u2-l1.svg',
    name: '古代诗歌鉴赏（一）：鉴赏诗歌形象与语言', author: '高考复习', chapter: '古代诗歌鉴赏（一）· 形象与语言', difficulty: '中等',
      content: [
    ...
    { id: 'zt2-u2-l2',    cover: 'assets/cover/chinese/zt2-u2-l2.svg',
    name: '古代诗歌鉴赏（二）：表达技巧与思想内容评价', author: '高考复习', chapter: '古代诗歌鉴赏（二）· 技巧与情感', difficulty: '中等',
      content: [
