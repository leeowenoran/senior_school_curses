(function () {
  ...
  v.points.push(
    ...
    { id: 'zt1-u3-l1', name: '《小说阅读（一）：思想内容、叙事艺术、情节、人物、环境、语言》', author: '高考复习', chapter: '现代文阅读Ⅱ · 小说阅读（一）', difficulty: '中等',
      content: [
    ...
    { id: 'zt1-u3-l2', name: '《小说阅读（二）：常见表现手法与意蕴探究》', author: '高考复习', chapter: '现代文阅读Ⅱ · 小说阅读（二）', difficulty: '中等',
      content: [
