...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx1-u3-l1',
      cover: 'assets/cover/chinese/bx1-u3-l1.svg',
      name: '短歌行',
      author: '曹操',
    ...
    {
      id: 'bx1-u3-l2',
      cover: 'assets/cover/chinese/bx1-u3-l2.svg',
      name: '归园田居（其一）',
      author: '陶渊明',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u3-l3',
      cover: 'assets/cover/chinese/bx1-u3-l3.svg',
      name: '梦游天姥吟留别',
      author: '李白',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '较难',
    ...
    {
      id: 'bx1-u3-l4',
      cover: 'assets/cover/chinese/bx1-u3-l4.svg',
      name: '登高',
      author: '杜甫',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u3-l5',
      cover: 'assets/cover/chinese/bx1-u3-l5.svg',
      name: '琵琶行（并序）',
      author: '白居易',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '较难',
    ...
    {
      id: 'bx1-u3-l6',
      cover: 'assets/cover/chinese/bx1-u3-l6.svg',
      name: '念奴娇·赤壁怀古',
      author: '苏轼',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u3-l7',
      cover: 'assets/cover/chinese/bx1-u3-l7.svg',
      name: '永遇乐·京口北固亭怀古',
      author: '辛弃疾',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '较难',
    ...
    {
      id: 'bx1-u3-l8',
      cover: 'assets/cover/chinese/bx1-u3-l8.svg',
      name: '声声慢',
      author: '李清照',
      chapter: '第三单元 生命的诗意（古代诗歌）',
      difficulty: '中等',
