...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx2-u3-l1',
      cover: 'assets/cover/chinese/bx2-u3-l1.svg',
      name: '《青蒿素：人类征服疾病的一小步》',
      author: '屠呦呦',
    ...
    {
      id: 'bx2-u3-l2',
      cover: 'assets/cover/chinese/bx2-u3-l2.svg',
      name: '《一名物理学家的教育历程》',
      author: '加来道雄',
      chapter: '第三单元 探索与发现（知识性读物）',
      difficulty: '中等',
    ...
    {
      id: 'bx2-u3-l3',
      cover: 'assets/cover/chinese/bx2-u3-l3.svg',
      name: '《中国建筑的特征》',
      author: '梁思成',
      chapter: '第三单元 探索与发现（知识性读物）',
      difficulty: '较难',
    ...
    {
      id: 'bx2-u3-l4',
      cover: 'assets/cover/chinese/bx2-u3-l4.svg',
      name: '《说"木叶"》',
      author: '林庚',
      chapter: '第三单元 探索与发现（知识性读物）',
      difficulty: '较难',
