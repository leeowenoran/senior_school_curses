...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx2-u6-l1',
      cover: 'assets/cover/chinese/bx2-u6-l1.svg',
      name: '《祝福》',
      author: '鲁迅',
    ...
    {
      id: 'bx2-u6-l2',
      cover: 'assets/cover/chinese/bx2-u6-l2.svg',
      name: '《林教头风雪山神庙》',
      author: '施耐庵',
      chapter: '第六单元 观察与批判（小说）',
      difficulty: '中等',
    ...
    {
      id: 'bx2-u6-l3',
      cover: 'assets/cover/chinese/bx2-u6-l3.svg',
      name: '《装在套子里的人》',
      author: '契诃夫',
      chapter: '第六单元 观察与批判（小说）',
      difficulty: '中等',
    ...
    {
      id: 'bx2-u6-l4',
      cover: 'assets/cover/chinese/bx2-u6-l4.svg',
      name: '《促织》',
      author: '蒲松龄',
      chapter: '第六单元 观察与批判（小说）',
      difficulty: '较难',
    ...
    {
      id: 'bx2-u6-l5',
      cover: 'assets/cover/chinese/bx2-u6-l5.svg',
      name: '《变形记》',
      author: '卡夫卡',
      chapter: '第六单元 观察与批判（小说）',
      difficulty: '较难',
