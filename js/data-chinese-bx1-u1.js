...
(function () {
  ...
  v.points.push(
    ...
    {
      id: 'bx1-u1-l1',
      cover: 'assets/cover/chinese/bx1-u1-l1.jpg',
      name: '沁园春·长沙',
      author: '毛泽东',
    ...
    {
      id: 'bx1-u1-l2',
      cover: 'assets/cover/chinese/bx1-u1-l2.jpg',
      name: '立在地球边上放号',
      author: '郭沫若',
      chapter: '第一单元 青春激扬（诗歌与小说）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u1-l3',
      cover: 'assets/cover/chinese/bx1-u1-l3.jpg',
      name: '红烛',
      author: '闻一多',
      chapter: '第一单元 青春激扬（诗歌与小说）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u1-l4',
      cover: 'assets/cover/chinese/bx1-u1-l4.jpg',
      name: '百合花',
      author: '茹志鹃',
      chapter: '第一单元 青春激扬（诗歌与小说）',
      difficulty: '中等',
    ...
    {
      id: 'bx1-u1-l5',
      cover: 'assets/cover/chinese/bx1-u1-l5.jpg',
      name: '哦，香雪',
      author: '铁凝',
      chapter: '第一单元 青春激扬（诗歌与小说）',
      difficulty: '中等',
